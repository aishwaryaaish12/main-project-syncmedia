...
export default function MarketingContentInfo() {
    ...
    <Stack spacing={3}>
      {mdUp && (
        <Image
          ...
          src="/assets/illustrations/illustration-contentlibrary.jpg"
          sx={{ width: {md:'400px',lg:'500px'}, mt:{xs:'2rem',md:'8rem',lg:'11rem'}, mr:{md:'6rem'}}}
        />
      )}
