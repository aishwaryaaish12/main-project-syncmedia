    ...
    >
      <Grid container spacing={3} justifyContent="space-between">
        ...
        <Grid xs={12} md={6} lg={6}>
          ...
          >
            {/* <Typography variant="h3" sx={{color:'primary.darker'}}>New Social Media</Typography> */}

            {/* <Typography sx={{ color: 'text.secondary' }}>
              We normally respond within 2 business days
            </Typography> */}
          </Stack>
            <Typography variant="h4" sx={{color:'primary.darker',mb:3}}>Create  New Social Media</Typography>
...
/>
              ...
              <RHFTextField name="fullName" label="Social Media Name" />
